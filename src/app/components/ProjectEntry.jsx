...
export default function ProjectEntry({
  ...
  if (size === "large") {
    return (
      <div className="row-span-2 col-span-2 rounded-xl border-2 border-zinc-700/10 bg-zinc-50 dark:bg-zinc-900 bg-cover bg-black/30 p-4 pb-0">
  ...
  return (
    <div
      className={`row-span-1 col-span-2 rounded-xl border-2 border-zinc-700/10 bg-zinc-50 dark:bg-zinc-900 bg-cover bg-black/30 p-4`}
    >
