...
export default function ProjectEntry({
  ...
  if (size === "large") {
    return (
      <div className="row-span-2 col-span-2 rounded-xl  bg-stone-50 dark:bg-stone-900 bg-cover bg-black/30 p-4 pb-0">
  ...
  return (
    <div
      className={`row-span-1 col-span-2 rounded-xl bg-stone-50 dark:bg-stone-900 bg-cover bg-black/30 p-4`}
    >
